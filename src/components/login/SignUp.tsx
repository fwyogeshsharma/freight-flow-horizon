...
import { ArrowLeft, UserPlus, Phone, Shield } from "lucide-react";
    ...
    try {
      ...
      if (response.status >= 200 && response.status < 300) {
        ...
        if (data.test_otp) {
          ...
          console.log(`Registration OTP is :: ${data.test_otp}`);
        }
        ...
        <Card className="w-full max-w-md shadow-2xl border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl">
          <CardHeader className="text-center space-y-6">
            ...
            <CardDescription className="text-muted-foreground text-base">
              Join RollingRadius to streamline your logistics
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-8">
            ...
            <Button
              ...
              className="w-full h-14 bg-[#3997CD] from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 text-white font-semibold text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
            >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Your phone number will be verified via OTP to ensure
                    security
                  </p>
                </div>
              </div>
