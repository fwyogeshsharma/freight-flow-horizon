...
const Homepage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="fixed top-0 w-full bg-[#FFFFFF] backdrop-blur-md border-b border-gray-100 z-50 shadow-sm">
        <div className="container mx-auto px-6 py-2">
          <div className="flex justify-between items-center">
            <img
              src="\rr_full_transp.jpg"
              alt="RollingRadius"
      ...
      <section id="home">
        <div
          ...
          style={{
            backgroundImage: `url('/truck2.png')`,
        ...
        >
          ...
          <div className=" container mx-auto px-4 relative z-10 text-center">
            ...
            <h1
              className={`logo-heading text-4xl leading-[1.3] md:text-6xl md:leading-[1.3] font-extrabold mb-4 bg-[#3997CD] from-cyan-400 to-blue-400 bg-clip-text text-transparent transform transition-all duration-1000 delay-200 ${
                isVisible
                  ? "translate-y-0 opacity-100"
                  : "translate-y-12 opacity-0"
              }`}
            ...
            >
              Streamline your logistics with real-time tracking, intelligent
              load matching, and seamless operations.
            </p>
            <div
            ...
            >
              <Button
                size="lg"
                className="text-base px-8 py-3 bg-[#3997CD] from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-full"
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base px-8 py-3 border-cyan-300 text-[#3997CD] hover:bg-cyan-500/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-full backdrop-blur-sm"
      ...
      <section
        id="booking"
        className="py-12 bg-gradient-to-br from-primary-50 to-blue-50"
      >
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Get instant quotes and book reliable transportation for your
                goods. Our platform connects you with verified drivers and
                ensures safe, timely delivery.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-5 max-w-sm mx-auto w-full">
              ...
              {bookingStep === 1 && (
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="drop" className="text-sm">
                      Drop Location
                    </Label>
                    <div className="relative">
                      <Input
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {vehicleTypes.map((vehicle) => (
                        <div
                          key={vehicle.name}
                          className="border-2 border-gray-200 rounded-lg p-2 cursor-pointer hover:border-primary-500 transition-colors text-center"
                        >
              ...
              {bookingStep === 4 && (
                <div className="text-center space-y-3">
                  ...
                  <p className="text-gray-600 text-sm">
                    Your booking request has been submitted. Our team will
                    contact you shortly with the best quotes from verified
                    drivers.
                  </p>
                  <Button
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="text-center space-y-3 p-4">
              ...
              <p className="text-gray-600 text-sm">
                ...
                instant updates throughout the journey.
              </p>
            </div>
            ...
            <div className="text-center space-y-3 p-4">
              ...
              <p className="text-gray-600 text-sm">
                All shipments are fully insured with verified drivers and secure
                handling protocols.
              </p>
            </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Comprehensive logistics solutions for all your transportation
              needs
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Complete truck capacity for large shipments",
                icon: "🚛",
              },
              {
                title: "Part Load",
                desc: "Cost-effective shipping for smaller loads",
                icon: "📦",
              },
              {
                title: "Express Delivery",
                desc: "Fast and urgent delivery services",
                icon: "⚡",
              },
              {
                title: "Warehousing",
                desc: "Storage and inventory management",
                icon: "🏭",
              },
            ].map((service, index) => (
              <div
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div>
              ...
              <p className="text-gray-400 mb-3 text-sm">
                Revolutionizing logistics with technology-driven solutions for
