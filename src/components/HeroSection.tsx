...
const HeroSection = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-accent/10 logistics-pattern">
      {/* Hero Section */}
      <div className="container mx-auto px-4 pt-20 pb-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">RollingRadius</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {features.map((feature, index) => <Card key={index} className="border-2 hover:border-primary/30 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {["Super Admin", "Fleet Owner", "Factory Owner", "Transport Agent", "Driver", "Consignee"].map((role, index) => <div key={index} className="p-4 bg-white/80 rounded-lg border hover:border-primary/30 transition-colors">
